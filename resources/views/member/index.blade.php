                                ...
                                <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <img class="avatar" src="{{ asset('assets/images/xs/avatar2.jpg') }}" data-toggle="tooltip" title="" data-original-title="Avatar Name"/>
                                                <div class="ml-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <img class="avatar" src="{{ asset('assets/images/xs/avatar3.jpg') }}" data-toggle="tooltip" title="" data-original-title="Avatar Name"/>
                                                <div class="ml-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="width45">
                                                <img class="avatar" src="{{ asset('assets/images/xs/avatar1.jpg') }}"  data-toggle="tooltip" title="Avatar Name"/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="width45">
                                                <img class="avatar" src="{{ asset('assets/images/xs/avatar2.jpg') }}"  data-toggle="tooltip" title="Avatar Name"/>
                                            </td>
                                            <td>
